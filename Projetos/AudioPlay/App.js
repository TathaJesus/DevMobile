...
export default function App() {
    ...
    // Estado para controlar se o som está em loop
    const [isLooping, setIsLoop] = useState(false);

    // Função assíncrona para carregar o arquivo de audio
    async function loadSound() {
        ...
        try {
            ...
            console.error('Error ao carregar o som:', error);
        }
    }
    ...
    async function playSound() {
        if (sound) {
            ...
            try {
                ...
                console.error('Error ao tocar o som:', error);
            }
        }
    }
    ...
    async function setLooping() {
        if (sound) {
            try {
                ...
                console.error('Error no definir o looping:', error);
            }
        }
    }
